...
namespace ParveenEvent.Controllers
{
    public class HomeController : Controller
    {
        ...
        #region "Report"
        public ActionResult RegisteredReposrt()
        {
            regmodelcontext db = new regmodelcontext();

            List<tbl_Reg> UserList = db.regusers.OrderBy(x => x.Cus_Id).ToList();
            if (Session["UserID"] != null && ((String)Session["IsActive"]).ToLower() == "true")
            {
        ...
        public ActionResult Absencereport()
        {
            ...
            List<tbl_Reg> UserList = db.regusers.Where(x=>x.IsPresent!="Y").OrderBy(x=>x.Cus_Id).ToList();
            if (Session["UserID"] != null && ((String)Session["IsActive"]).ToLower() == "true")
            {
        ...
        public ActionResult Giftreceivedtreport()
        {

            regmodelcontext db = new regmodelcontext();

            List<tbl_Reg> UserList = db.regusers.Where(x => x.IsGift == "Y").OrderBy(x => x.Cus_Id).ToList();
            if (Session["UserID"] != null && ((String)Session["IsActive"]).ToLower() == "true")
            {
        ...
        public ActionResult Giftnotreceivedtreport()
        {

            regmodelcontext db = new regmodelcontext();

            List<tbl_Reg> UserList = db.regusers.Where(x => x.IsPresent=="Y" && x.IsGift!="Y").OrderBy(x => x.Cus_Id).ToList();
            if (Session["UserID"] != null && ((String)Session["IsActive"]).ToLower() == "true")
            {
        ...
        public ActionResult Login(UserProfile objUser)
        {
            ...
            {
                using (ParveenEntities db = new ParveenEntities())
                {
                    ...
                    if (obj != null)
                    {
                        ...
                        Session["IsActive"] = Convert.ToString(obj.IsActive);
